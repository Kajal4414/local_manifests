...
git clone -b 13.0-new https://github.com/Kajal4414/android_vendor_xiaomi_spes.git vendor/xiaomi/spes
...
(cd vendor/xiaomi/spes && git pull && git reset --hard HEAD~1) # spes: Update blobs from SPESINGlobal_OS1.0.2.0.TGCINXM
